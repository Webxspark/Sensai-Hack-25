...
type TabType = 'courses' | 'cohorts' | 'members' | 'assessments';
...
export default function ClientSchoolAdminView({id}: { id: string }) {
    ...
    const [isCreateAssessmentSheetOpen, setIsCreateAssessmentSheetOpen] = useState(false);
    ...
    return (
        <>
                    ...
                    <main>
                        ...
                        <div className="mb-8">
                            <div className="flex border-b border-gray-800">
                                ...
                                <button
                                    className={`px-4 py-2 font-light cursor-pointer ${activeTab === 'assessments' ? 'text-white border-b-2 border-white' : 'text-gray-400 hover:text-white'}`}
                                    onClick={() => handleTabChange('assessments')}
                                >
                                    <div className="flex items-center">
                                        <LaptopMinimalCheck size={16} className="mr-2"/>
                                        Assessments
                                    </div>
                                </button>
                                <button
                                ...
                                <div>
                                    {school.courses.length > 0 ? (
                                        ...
                                        <div className="flex flex-col items-center justify-center py-20">
                                            <h2 className="text-4xl font-light mb-4">What if your next big idea became a
                                                course?</h2>
                            ...
                            {activeTab === 'cohorts' && (
                                <div>
                                    {school.cohorts.length > 0 ? (
                                        ...
                                        <div className="flex flex-col items-center justify-center py-20">
                                            <h2 className="text-4xl font-light mb-4">Bring your courses to life with
                                                cohorts</h2>
                                            <p className="text-gray-400 mb-8">Create groups of learners and assign them
                                                courses to learn together</p>
                                            <button
                                                className="px-6 py-3 bg-white text-black text-sm font-medium rounded-full hover:opacity-90 transition-opacity focus:outline-none cursor-pointer"
                                                onClick={() => {
                                                    setIsCreateCohortDialogOpen(true);
                                        ...
                                        <>
                                            <div className="flex justify-start items-center mb-6">
                                                <button
                                                    className="px-6 py-3 bg-white text-black text-sm font-medium rounded-full hover:opacity-90 transition-opacity focus:outline-none cursor-pointer"
                                                    onClick={() => {
                                                        setIsCreateAssessmentSheetOpen(true);
                                                    }}
                                                >
                                                    Create Assessment
                                                </button>
                                    ...
                                    <div className="overflow-hidden rounded-lg border border-gray-800">
                                        <table className="min-w-full divide-y divide-gray-800">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col"
                                                    className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Email
                                                </th>
                                                <th scope="col"
                                                    className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Role
                                                </th>
                                            </tr>
                                            </thead>
            ...
            <AssessmentCreateSheet
                open={isCreateAssessmentSheetOpen}
                onClose={() => setIsCreateAssessmentSheetOpen(false)}
                schoolId={id}
